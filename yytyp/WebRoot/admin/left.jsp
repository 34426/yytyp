    ...
    <div id="sidebar">
	    <div id="sidebar-wrapper">
		      ...
		      <ul id="main-nav">
			       ...
			       <li><a href="#" class="nav-top-item" style="font-family: 微软雅黑;font-size: 15px;">商品类别管理</a>
			          <ul>
			            <li><a href="<%=path %>/leibieMana.action"  target="rightFrame"style="font-family: 微软雅黑;font-size: 13px;">商品类别管理</a></li>
			            <li><a href="<%=path %>/admin/leibie/leibieAdd.jsp" target="rightFrame" style="font-family: 微软雅黑;font-size: 13px;">添加商品类别</a></li>
			          </ul>
			       </li>
			       <li><a href="#" class="nav-top-item" style="font-family: 微软雅黑;font-size: 15px;">商品信息管理</a>
			          <ul>
			            <li><a href="<%=path %>/goodsMana.action"  target="rightFrame"style="font-family: 微软雅黑;font-size: 13px;">商品信息管理</a></li>
			            <li><a href="<%=path %>/admin/goods/goodsAdd.jsp" target="rightFrame" style="font-family: 微软雅黑;font-size: 13px;">添加商品信息</a></li>
			          </ul>
			       </li>
			       ...
			       <li><a href="#" class="nav-top-item" style="font-family: 微软雅黑;font-size: 15px;">留言反馈管理</a>
			          <ul>
			            <li><a href="<%=path %>/liuyanMana.action"  target="rightFrame"style="font-family: 微软雅黑;font-size: 13px;">留言反馈管理</a></li>
			          </ul>
			       </li>
			       <li><a href="#" class="nav-top-item" style="font-family: 微软雅黑;font-size: 15px;">促销信息管理</a>
			          <ul>
			            <li><a href="<%=path %>/cuxiaoMana.action"  target="rightFrame"style="font-family: 微软雅黑;font-size: 13px;">促销信息管理</a></li>
			            <li><a href="<%=path %>/admin/cuxiao/cuxiaoAdd.jsp"  target="rightFrame"style="font-family: 微软雅黑;font-size: 13px;">添加促销信息</a></li>
			          </ul>
			       </li>
	          </ul>    
	    </div>
